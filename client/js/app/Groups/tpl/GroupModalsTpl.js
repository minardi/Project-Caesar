        ...
        '<div class="modal-dialog">',
            '<div class="modal-content">',
                ...
                '<div class="modal-footer clearfix">',
                    '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>',
                    '<button type="button" class="btn btn-primary add-new-group" data-dismiss="modal">Add</button>',
                '</div>',
            '</div>',
        '</div>',
    '</div>'
    ...
    '<div class="modal fade" id="groupEdit" tabindex="-1" role="dialog">',
        '<div class="modal-dialog">',
            '<div class="modal-content">',
                ...
                '<div class="modal-footer clearfix">',
                    '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>',
                    '<button type="button" class="btn btn-primary edit-group" data-dismiss="modal">Submit</button>',
                '</div>',
            '</div>',
        '</div>',
    '</div>'
