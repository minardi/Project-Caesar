                            ...
                            '<div class="teachers-block col-sm-6">',
                                ...
                                '<select class="form-control" multiple name="Teachers">',
                                    '<% allTeachers.forEach(function(currentTeacher) { %>',
                                        '<option <% _.each(teachers, function (val) {',
                                            'if (val === currentTeacher.get("lastName") + " " + currentTeacher.get("name")) {%> selected <%};%>',
                                            '<% }) %>',
                                        '><%= currentTeacher.get("lastName") + " " + currentTeacher.get("name") %></option>',
                                    '<% }, this); %>',
                                '</select>',
                            '</div>',
